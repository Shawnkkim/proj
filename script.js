...
// green,red and blue icons; different color for each temp
...
//using Leaflet// setting map // osm dataset
...
var streets = L.tileLayer('https://api.mapbox.com/styles/v1/{id}/tiles/{z}/{x}/{y}?access_token={accessToken}', {
    ...
    tileSize: 512,
    zoomOffset: -1,
    accessToken: 'pk.eyJ1Ijoic2hhd25ra2ltIiwiYSI6ImNrenlxeDc0MTAyd2YzZ3Q4cHZ2cTRob3cifQ.5qErpiByjoC8BuMeYQpkzg'
...
function subscribeTopic(){
    ...
    console.log("Subcribed to topic: " + subtopic);
    document.getElementById("substatus").innerHTML = "Subscribed to topic: " + subtopic;
}
